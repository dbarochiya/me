          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                <li><a href="https://twitter.com/dbarochiya" target="_blank" rel="noopener noreferrer"><i className="icon-twitter2" /></a></li>
                ...
                <li><a href="https://github.com/ddbarochiya" target="_blank" rel="noopener noreferrer"><i className="icon-github"></i></a></li>
